...
def main(dataset_name):
    ...
    for i, complexity_func in enumerate(complexity_funcs):
        ...
        print(
            "complexity of graphlet dataset: {:.2e}".format(decimal.Decimal(complexity))
        )
        ...
        complexity = sum([complexity_func(n) for n in graph_node_num])
        print(
            "complexity of neighborhood dataset: {:.2e}".format(
                decimal.Decimal(complexity)
            )
        )
