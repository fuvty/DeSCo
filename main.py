...
def main():
    ...
    train_dataset = load_data(train_dataset_name, transform=zero_node_feat_transform)
    ...
    train_workload.generate_pipeline_datasets(depth_neigh=args_neighborhood.depth, neighborhood_transform=neighborhood_transform)
    test_workload.generate_pipeline_datasets(depth_neigh=args_neighborhood.depth, neighborhood_transform=neighborhood_transform)
    ...
    # lightningDataLoader = pyg.data.LightningDataset(train_dataset= train_workload.neighborhood_dataset, val_dataset= test_workload.neighborhood_dataset,test_dataset= test_workload.neighborhood_dataset, batch_size=args_opt.neighborhood_batch_size)
